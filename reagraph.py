...
class make_reaction_graph:
    def __init__(self, time_summary_dict=time_summary_dict, file_path="assets/result_reaction.png"):
        self.time_summary_dict = time_summary_dict
        self.emotion_list=["JOIN", "LEAVE", "AGREE", "RAISE_HAND"]
